...
namespace Offsets
{
	void Init(void)
	{
		...
		Player::m_hViewModel = GetOffset("DT_BasePlayer", "m_hViewModel[0]");
		...
		Player::m_hMyWeapons = GetOffset("DT_BaseCombatCharacter", "m_hMyWeapons");
		Player::m_hMyWearables = GetOffset("DT_BaseCombatCharacter", "m_hMyWearables");
		...
		Weapon::m_iViewModelIndex = GetOffset("DT_BaseCombatWeapon", "m_iViewModelIndex");
		Weapon::m_iWorldModelIndex = GetOffset("DT_BaseCombatWeapon", "m_iWorldModelIndex");
		Weapon::m_iClip1 = GetOffset("DT_BaseCombatWeapon", "m_iClip1");
		Weapon::m_iState = GetOffset("DT_BaseCombatWeapon", "m_iState");
		Weapon::m_hWeaponWorldModel = GetOffset("DT_BaseCombatWeapon", "m_hWeaponWorldModel");
		Weapon::m_bIsBroken = GetOffset("DT_FuncConveyor", "m_bIsBroken");

		Weapon::m_nModelIndex = GetOffset("DT_BaseViewModel", "m_nModelIndex");
		Weapon::m_hOwner = GetOffset("DT_BaseViewModel", "m_hOwner");
		Weapon::m_hWeapon = GetOffset("DT_BaseViewModel", "m_hWeapon");
		...
		Attribute::m_iEntityQuality = GetOffset_Nit("DT_BaseAttributableItem", "m_AttributeManager") + GetOffset_Nit("DT_BaseAttributableItem", "m_Item") + GetOffset_Nit("DT_BaseAttributableItem", "m_iEntityQuality");
		Attribute::m_iAccountID = GetOffset_Nit("DT_BaseAttributableItem", "m_AttributeManager") + GetOffset_Nit("DT_BaseAttributableItem", "m_Item") + GetOffset_Nit("DT_BaseAttributableItem", "m_iAccountID");
		Attribute::m_iItemIDHigh = GetOffset_Nit("DT_BaseAttributableItem", "m_AttributeManager") + GetOffset_Nit("DT_BaseAttributableItem", "m_Item") + GetOffset_Nit("DT_BaseAttributableItem", "m_iItemIDHigh");
		Attribute::m_iItemIDLow = GetOffset("DT_BaseAttributableItem", "m_iItemIDLow");
		Attribute::m_nFallbackPaintKit = GetOffset("DT_BaseAttributableItem", "m_nFallbackPaintKit");
		Attribute::m_nFallbackSeed = GetOffset("DT_BaseAttributableItem", "m_nFallbackSeed");
		Attribute::m_flFallbackWear = GetOffset("DT_BaseAttributableItem", "m_flFallbackWear");
		Attribute::m_nFallbackStatTrak = GetOffset("DT_BaseAttributableItem", "m_nFallbackStatTrak");
		Attribute::m_OriginalOwnerXuidLow = GetOffset("DT_BaseAttributableItem", "m_OriginalOwnerXuidLow");
		Attribute::m_OriginalOwnerXuidHigh = GetOffset("DT_BaseAttributableItem", "m_OriginalOwnerXuidHigh");
