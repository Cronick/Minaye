...
void CVarSystem::Init()
{
	...
	g_pCvar.addCvar("aimbot_key", 5, false);
	g_pCvar.addCvar("aimbot_fov", 180, false);
	g_pCvar.addCvar("aimbot_distance_fov", 1, false);
	g_pCvar.addCvar("aimbot_spot", 0, false);
	g_pCvar.addCvar("aimbot_smooth", 0, false);
	g_pCvar.addCvar("aimbot_rcs", 0, false);

	g_pCvar.addCvar("aimbot_silent", 0, false);
	g_pCvar.addCvar("aimbot_norecoil", 0, false);
	g_pCvar.addCvar("aimbot_autofire", 0, false);
	g_pCvar.addCvar("aimbot_antiaim", 0, false);
	...
	g_pCvar.addCvar("esp_weapon", 0, false);
	g_pCvar.addCvar("esp_droppedweapons", 1, false);
	g_pCvar.addCvar("esp_drawspot", 1, false);
	g_pCvar.addCvar("esp_skeleton", 0, false);
	g_pCvar.addCvar("esp_players", 1, false);
	g_pCvar.addCvar("esp_bombinfo", 1, false);
	g_pCvar.addCvar("esp_nade", 1, false);
	g_pCvar.addCvar("esp_money", 0, false);
	...
	g_pCvar.addCvar("misc_bhop", 0, false);
	g_pCvar.addCvar("misc_autopistol", 1, false);
	g_pCvar.addCvar("misc_ranks", 1, false);
	g_pCvar.addCvar("misc_skinchanger", 1, false);

	g_pCvar.addCvar("misc_skinchanger_knife", 0, false);
	g_pCvar.addCvar("misc_skinchanger_knifeskin_t", 0, false);
	g_pCvar.addCvar("misc_skinchanger_knifeskin_ct", 0, false);

	g_pCvar.addCvar("menu_x", 500, false);
	g_pCvar.addCvar("menu_y", 300, false);

	g_pCvar.addCvar("menu_r", 250, false);
	g_pCvar.addCvar("menu_g", 0, false);
	g_pCvar.addCvar("menu_b", 0, false);
