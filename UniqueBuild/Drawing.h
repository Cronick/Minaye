...
public:
	...
	unsigned long font_esp, font_menu, font_menutab, font_menutitle, font_menuarrows, font_money, menu_title, menu_webdings, menu_ready, menu_tabs, menu_features, font_menuoptions, esp_font;
};
