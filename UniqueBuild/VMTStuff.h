...
extern ULONG PatternSearch(std::string sModuleName, PBYTE pbPattern, std::string sMask, ULONG uCodeBase, ULONG uSizeOfCode);
extern HMODULE GetModuleHandleSafe(const char* pszModuleName);

extern CVMTHookManager* g_phkCreateMove;
extern CVMTHookManager* g_phkFrameStageNotify;
extern CVMTHookManager* g_phkPaintTraverse;
extern CVMTHookManager* g_phkPlaySound;