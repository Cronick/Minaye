...
public:
	...
	CBaseHandle* MyWeapons()
	{
		return (CBaseHandle*)((uintptr_t)this + Offsets::Player::m_hMyWeapons);
	}
	CBaseHandle* GetWearables()
	{
		if (!this) return nullptr;
		return reinterpret_cast<CBaseHandle*>(this + Offsets::Player::m_hMyWearables);
	}
	int GetShotsFired()
	{
	...
	{
		return *(CBaseHandle*)((uintptr_t)this + Offsets::Player::m_hViewModel);
	}
	int m_Local()
	{
...
public:
	...
	{
		switch (this->GetWeaponID_test())
		{
		case ITEM_NONE:
			return "Unknown Weapon"; break;
		case WEAPON_DEAGLE:
			return "Deagle"; break;
		case WEAPON_DUALS:
...
public:
	...
	int* ViewModelIndex()
	{
		return (int*)((uintptr_t)this + Offsets::Weapon::m_iViewModelIndex);
	}
	int* WorldModelIndex()
	{
		return (int*)((uintptr_t)this + Offsets::Weapon::m_iWorldModelIndex);
	}
	int* ModelIndex()
	{
		if (!this)
			return 0;
		return (int*)((uintptr_t)this + Offsets::Weapon::m_nModelIndex);
	}
	HANDLE WeaponWorldModel()
	{
	...
	int GetWeaponID_test()
	{
		if (!this)
			return 0;
		return *(int*)((uintptr_t)this + Offsets::Attribute::m_iItemDefinitionIndex); //m_AttributeManager + m_Item + m_iItemDefinitionIndex
	}
	int* WeaponID()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_iItemDefinitionIndex); //m_AttributeManager + m_Item + m_iItemDefinitionIndex
	...
	int* GetEntityQuality() {
		...
		return (int*)((uintptr_t)this + Offsets::Attribute::m_iEntityQuality);
	}
	...
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_nFallbackPaintKit);
	}
	int* FallbackSeed()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_nFallbackSeed);
	}
	float* FallbackWear()
	{
		return (float*)((uintptr_t)this + Offsets::Attribute::m_flFallbackWear);
	}
	int* FallbackStatTrak()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_nFallbackStatTrak);
	}
	int* OwnerXuidLow()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_OriginalOwnerXuidLow);
	}
	int* OwnerXuidHigh()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_OriginalOwnerXuidHigh);
	}
	int* AccountID()
	{
		return (int*)((uintptr_t)this + Offsets::Attribute::m_iAccountID);
	}
	int* ItemIDHigh()
	{
		//return (int*)((uintptr_t)this + 0x1F0);
		return (int*)((uintptr_t)this + Offsets::Attribute::m_iItemIDHigh);
	}
	int* ItemIDLow()
	{
		return (int*)((uintptr_t)this + 0x1F4);
		//return (int*)((uintptr_t)this + Offsets::Attribute::m_iItemIDLow);
	}
	bool IsPistol(void)
	{
...
public:
	...
	int* GetWeaponModelIndex() {
		static uintptr_t m_nModelIndex = Offsets::Weapon::m_nModelIndex;
		return reinterpret_cast<int*>(uintptr_t(this) + m_nModelIndex);
	}

	inline void SetModelIndex(int nModelIndex) {
		*(int*)((DWORD)this + Offsets::Weapon::m_nModelIndex) = nModelIndex;
	}

	inline DWORD GetOwner() {

		return *(PDWORD)((DWORD)this + Offsets::Player::m_hOwner);
	}
	/*
	inline DWORD GetWeapon() {

		return *(PDWORD)((DWORD)this + Offsets::Weapon::m_hWeapon);
	}
	*/
	int GetWeapon() {
		static uintptr_t m_hWeapon = Offsets::Weapon::m_hWeapon;
		return *reinterpret_cast<int*>(uintptr_t(this) + m_hWeapon);
	}

	int* GetModelIndexSkin() {
		static uintptr_t m_nModelIndex = Offsets::Weapon::m_nModelIndex;
		return reinterpret_cast<int*>(uintptr_t(this) + m_nModelIndex);
	}
};
...
public:
	...
	inline void* GetModelInfo(int Index) {
	...
	inline int GetWeaponModelIndex(const char* Filename) {
		return getvfunc<int(__thiscall *)(void*, const char*)>(this, 2)(this, Filename);
	}
	inline const char* GetModelsName(const void* Model) {
	...
	void GetModelMaterials(const model_t *model, int count, IMaterial** ppMaterial)
	{
		...
		getvfunc<oGetModelMaterials>(this, 19)(this, model, count, ppMaterial);
	}
